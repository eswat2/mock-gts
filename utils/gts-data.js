const list = [
  ...
  ['Alpine', 'Vision GT', 'Gr.X', 2014],
  ['Alpine', 'Vision GT 2017', 'Gr.1', 2014],
  ['Alpine', 'Vision GT Race Mode', 'Gr.X', 2014],
  ['Amuse', 'S2000 GT1 Turbo', 'N 600', 2004],
  ['Aston Martin', 'DP-100 Vision GT', 'Gr.X', 2014],
  ...
  ['Audi', 'e-tron Vision GT', 'Gr.X', 2018],
  ...
  ['BMW', 'Vision GT', 'Gr.X', 2014],
  ['BMW', 'Z4 GT3', 'Gr.3', 2011],
  ['BMW', 'Z8', 'N 400', 2001],
  ['Bugatti', 'Vision GT', 'Gr.1', 2015],
  ['Bugatti', 'Vision GT Gr.1', 'Gr.1', 2015],
  ['Bugatti', 'Veyron 16.4', 'N 1000', 2013],
  ['Bugatti', 'Veyron Gr.4', 'Gr.4', 2013],
  ['Chaparral', 'Chevrolet Chaparral 2X Vision GT', 'Gr.X', 2014],
  ...
  ['Daihatsu', 'COPEN RJ Vision GT', 'Gr.X', 2017],
  ...
  ['Dodge', 'SRT Tomahawk GTS-R Vision GT', 'Gr.X', 2015],
  ['Dodge', 'SRT Tomahawk S Vision GT', 'Gr.X', 2015],
  ['Dodge', 'SRT Tomahawk Vision GT (Gr.1)', 'Gr.1', 2015],
  ['Dodge', 'SRT Tomahawk X Vision GT', 'Gr.X', 2015],
  ...
  ['Fittipaldi Motors', 'EF7 Vision GT by Pininfarina', 'Gr.X', 2017],
  ...
  ['Honda', 'Sports Vision GT', 'Gr.X', 2017],
  ...
  ['Hyundai', 'N 2025 Vision GT', 'Gr.X', 2015],
  ['Hyundai', 'N 2025 Vision GT Gr.1', 'Gr.1', 2015],
  ['Infiniti', 'CONCEPT Vision GT', 'Gr.X', 2014],
  ...
  ['Jaguar', 'Vision GT Coupé', 'Gr.X', 2020],
  ...
  ['Lexus', 'LF-LC GT “Vision GT”', 'Gr.X', 2014],
  ...
  ['Mazda', 'LM55 Vision GT', 'Gr.X', 2014],
  ['Mazda', 'LM55 Vision GT Gr.1', 'Gr.1', 2014],
  ...
  ['McLaren', 'Ultimate Vision GT', 'Gr.X', 2017],
  ['McLaren', 'Ultimate Vision GT Gr.1', 'Gr.1', 2017],
  ...
  ['Mercedes-Benz', 'AMG Vision GT', 'Gr.X', 2013],
  ['Mercedes-Benz', 'AMG Vision GT Racing Series', 'Gr.X', 2014],
  ...
  ['MINI', 'MINI Clubman Vision GT', 'Gr.X', 2014],
  ['MINI', 'MINI Cooper S', 'N 200', 2005],
  ['MINI', "Mini-Cooper 'S'", 'N 100', 1965],
  ['Mitsubishi', 'Concept XR-PHEV EVOLUTION Vision GT', 'Gr.X', '2014'],
  ...
  ['Nissan', 'CONCEPT 2020 Vision GT', 'Gr.X', 2014],
  ...
  ['Peugeot', 'L500R HYbrid Vision GT', 'Gr.X', 2017],
  ['Peugeot', 'L750R HYbrid Vision GT', 'Gr.1', 2017],
  ['Peugeot', 'Vision GT', 'Gr.X', 2015],
  ['Peugeot', 'Vision GT (Gr.3)', 'Gr.3', 2015],
  ...
  ['Subaru', 'VIZIV GT Vision GT', 'Gr.X', 2014],
  ...
  ['Toyota', 'FT-1 Vision GT', 'Gr.X', 2014],
  ['Toyota', 'FT-1 Vision GT (Gr.3)', 'Gr.3', 2014],
  ...
  ['Volkswagen', 'GTI Roadster Vision GT', 'Gr.X', 2014],
  ['Volkswagen', 'GTI Supersport Vision GT', 'Gr.X', 2014],
  ['Volkswagen', 'GTI Vision GT (Gr.3)', 'Gr.3', 2014],
  ...
  ['Zagato', 'IsoRivolta Vision GT', 'Gr.X', 2017],
]
